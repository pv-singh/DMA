 ...
 */
public class OscilloscopeLines extends AbstractOscilloscope {

    public static final String NAME = "Oscilloscope Lines";
    ...
    protected void render(Graphics2D g2d, int width, int height,
        ...
        for (int i = 0; i < newSampleCount; i++) {
            ...
            g2d.drawLine(xOld, halfHeight, x, y);
            xOld = x;
            yOld = y;
        }

//        for (int c = 0; c < width && c < leftChannel.length; c++) {
//            int temp = halfHeight + (int) (quarterHeight * (leftChannel[c] + rightChannel[c]));
//            g2d.drawLine(c, halfHeight, c, temp);
//        }
    }
}
